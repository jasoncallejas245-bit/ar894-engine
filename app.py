...
if uploaded_file is not None:
    ...
    target_bet_name = lines[0] if lines else "High-Confidence Prop Selection"
    
    auto_prob = 0.59 if "goblin" in extracted_text.lower() or "alt" in extracted_text.lower() else 0.56
    auto_legs = 1 if len(extracted_text) < 50 else 2
